    ...
    <div className='container mt-4'>
        ...
        <div className='row'>
            <div className="col-md-7">              
                <form onSubmit={submitHandler} className="form">
                    <div className="form-group mr-auto">
                        <input name="naame" type="text"  placeholder="Enter Name Here" className="form-control" required></input>
                        <input name="email" type="email"  placeholder="Enter Email Here" className="form-control mt-2" required></input>
                        <input name="phone" type="number"  placeholder="Enter contact Number" className="form-control mt-2" required></input>
                    </div>
                        <button type="submit"  className="btn btn-transparent text-primary mt-2">[GET STARTED]</button>
                </form>
            </div>  
